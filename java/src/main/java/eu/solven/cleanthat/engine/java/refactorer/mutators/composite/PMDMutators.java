 ...
 *
 */
public class PMDMutators extends CompositeMutator<IMutator> implements IConstructorNeedsJdkVersion {

	static final Supplier<List<IMutator>> PMD = Suppliers.memoize(() -> MutatorsScanner
