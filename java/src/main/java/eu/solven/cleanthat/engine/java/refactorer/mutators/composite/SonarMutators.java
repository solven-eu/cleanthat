 ...
 *
 */
public class SonarMutators extends CompositeMutator<IMutator> implements IConstructorNeedsJdkVersion {

	static final Supplier<List<IMutator>> SONAR = Suppliers.memoize(() -> MutatorsScanner
