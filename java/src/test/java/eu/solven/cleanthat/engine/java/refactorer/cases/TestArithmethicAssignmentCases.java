...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.ArithmethicAssignmentCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestArithmethicAssignmentCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new ArithmethicAssignmentCases();
	}

	public TestArithmethicAssignmentCases(JavaParser javaParser,
			String testName,
