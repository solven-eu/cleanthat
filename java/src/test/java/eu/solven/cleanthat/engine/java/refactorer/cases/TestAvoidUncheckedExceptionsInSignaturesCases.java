...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.AvoidUncheckedExceptionsInSignaturesCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestAvoidUncheckedExceptionsInSignaturesCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new AvoidUncheckedExceptionsInSignaturesCases();
	}

	public TestAvoidUncheckedExceptionsInSignaturesCases(JavaParser javaParser,
			String testName,
