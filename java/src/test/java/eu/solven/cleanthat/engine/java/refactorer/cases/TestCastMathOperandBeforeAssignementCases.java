...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.CastMathOperandBeforeAssignementCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestCastMathOperandBeforeAssignementCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new CastMathOperandBeforeAssignementCases();
	}

	public TestCastMathOperandBeforeAssignementCases(JavaParser javaParser,
			String testName,
