...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.CollectionIndexOfToContainsCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestCollectionIndexOfToContainsCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new CollectionIndexOfToContainsCases();
	}

	public TestCollectionIndexOfToContainsCases(JavaParser javaParser,
			String testName,
