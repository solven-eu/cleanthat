...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.EmptyControlStatementCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestEmptyControlStatementCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new EmptyControlStatementCases();
	}

	public TestEmptyControlStatementCases(JavaParser javaParser,
			String testName,
