...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.GuavaStringsIsNullOrEmptyCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestGuavaStringsIsNullOrEmptyCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new GuavaStringsIsNullOrEmptyCases();
	}

	public TestGuavaStringsIsNullOrEmptyCases(JavaParser javaParser,
			String testName,
