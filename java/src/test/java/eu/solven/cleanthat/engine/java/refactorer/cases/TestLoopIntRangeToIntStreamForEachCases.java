...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.LoopIntRangeToIntStreamForEachCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestLoopIntRangeToIntStreamForEachCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new LoopIntRangeToIntStreamForEachCases();
	}

	public TestLoopIntRangeToIntStreamForEachCases(JavaParser javaParser,
			String testName,
