...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.NoOpCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestNoOpCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new NoOpCases();
	}

	public TestNoOpCases(JavaParser javaParser, String testName, ClassOrInterfaceDeclaration testCase) {
