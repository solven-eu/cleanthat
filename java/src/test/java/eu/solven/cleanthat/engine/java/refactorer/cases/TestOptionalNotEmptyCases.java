...
public class TestOptionalNotEmptyCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new OptionalNotEmptyCases();
	}

	public TestOptionalNotEmptyCases(JavaParser javaParser, String testName, ClassOrInterfaceDeclaration testCase) {
