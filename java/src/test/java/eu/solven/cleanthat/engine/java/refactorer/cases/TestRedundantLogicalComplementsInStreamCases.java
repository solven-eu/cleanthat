...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.RedundantLogicalComplementsInStreamCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestRedundantLogicalComplementsInStreamCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new RedundantLogicalComplementsInStreamCases();
	}

	public TestRedundantLogicalComplementsInStreamCases(JavaParser javaParser,
			String testName,
