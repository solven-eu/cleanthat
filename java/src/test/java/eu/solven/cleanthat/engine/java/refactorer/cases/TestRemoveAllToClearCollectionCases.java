...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.RemoveAllToClearCollectionCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestRemoveAllToClearCollectionCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new RemoveAllToClearCollectionCases();
	}

	public TestRemoveAllToClearCollectionCases(JavaParser javaParser,
			String testName,
