...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.RemoveExplicitCallToSuperCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestRemoveExplicitCallToSuperCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new RemoveExplicitCallToSuperCases();
	}

	public TestRemoveExplicitCallToSuperCases(JavaParser javaParser,
			String testName,
