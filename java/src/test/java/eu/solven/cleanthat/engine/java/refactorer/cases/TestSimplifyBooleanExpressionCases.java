...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.SimplifyBooleanExpressionCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestSimplifyBooleanExpressionCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new SimplifyBooleanExpressionCases();
	}

	public TestSimplifyBooleanExpressionCases(JavaParser javaParser,
			String testName,
