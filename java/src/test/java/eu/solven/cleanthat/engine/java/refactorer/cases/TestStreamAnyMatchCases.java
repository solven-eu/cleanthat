...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.StreamAnyMatchCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestStreamAnyMatchCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new StreamAnyMatchCases();
	}
