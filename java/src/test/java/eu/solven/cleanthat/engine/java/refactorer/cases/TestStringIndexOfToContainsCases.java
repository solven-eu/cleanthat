...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.StringIndexOfToContainsCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestStringIndexOfToContainsCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new StringIndexOfToContainsCases();
	}

	public TestStringIndexOfToContainsCases(JavaParser javaParser,
			String testName,
