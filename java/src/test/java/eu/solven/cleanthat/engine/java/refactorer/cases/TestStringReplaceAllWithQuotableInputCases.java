...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.StringReplaceAllWithQuotableInputCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestStringReplaceAllWithQuotableInputCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new StringReplaceAllWithQuotableInputCases();
	}

	public TestStringReplaceAllWithQuotableInputCases(JavaParser javaParser,
			String testName,
