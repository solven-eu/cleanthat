...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.StringToStringCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestStringToStringCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new StringToStringCases();
	}

	public TestStringToStringCases(JavaParser javaParser, String testName, ClassOrInterfaceDeclaration testCase) {
