...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.ThreadRunToThreadStartCases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestThreadRunToThreadStartCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new ThreadRunToThreadStartCases();
	}

	public TestThreadRunToThreadStartCases(JavaParser javaParser,
			String testName,
