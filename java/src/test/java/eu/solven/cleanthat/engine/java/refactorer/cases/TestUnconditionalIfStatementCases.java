...
public class TestUnconditionalIfStatementCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new ComparisonWithNaNCases();
	}

	public TestUnconditionalIfStatementCases(JavaParser javaParser,
			String testName,
