...
@Ignore("TODO")
public class TestUseDiamondOperatorCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new UseDiamondOperatorCases();
	}

	public TestUseDiamondOperatorCases(JavaParser javaParser, String testName, ClassOrInterfaceDeclaration testCase) {
