...
import eu.solven.cleanthat.engine.java.refactorer.cases.do_not_format_me.UseDiamondOperatorJdk8Cases;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

@Ignore("TODO")
public class TestUseDiamondOperatorJdk8Cases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new UseDiamondOperatorJdk8Cases();
	}
