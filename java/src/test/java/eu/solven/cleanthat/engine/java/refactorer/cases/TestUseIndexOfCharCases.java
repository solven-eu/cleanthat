...
public class TestUseIndexOfCharCases extends AParameterizesJavaparserRefactorerCases {

	private static AJavaparserRefactorerCases getStaticRefactorerCases() {
		return new UseIndexOfCharCases();
	}

	public TestUseIndexOfCharCases(JavaParser javaParser, String testName, ClassOrInterfaceDeclaration testCase) {
