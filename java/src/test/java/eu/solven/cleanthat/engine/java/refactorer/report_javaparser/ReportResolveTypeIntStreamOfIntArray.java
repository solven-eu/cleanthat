...
public class ReportResolveTypeIntStreamOfIntArray {
	static final String testCase = "import java.util.OptionalDouble;\n" + "import java.util.stream.IntStream;\n"
			+ "\n"
			+ "public class CaseIntStream {\n"
	...
	public static void main(String[] args) {
		...
		var ofCall = node.findAll(MethodCallExpr.class).get(0);

		System.out.println(ofCall.calculateResolvedType());
	}
}
