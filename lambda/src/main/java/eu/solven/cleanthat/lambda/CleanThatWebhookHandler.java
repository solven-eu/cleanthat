 ...
 */
public class CleanThatWebhookHandler extends SpringBootRequestHandler<Map<String, ?>, Map<String, ?>> {
	public CleanThatWebhookHandler() {
		// We should rely on META-INF/MANIFEST.MF, but sometimes, it does not work: we then declare the function
		// explicitly
		super(CleanThatWebhookLambdaFunction.class);
	}
}
