 ...
 */
public class DebugCheckConfigWebhooksLambdaFunction extends CheckWebhooksLambdaFunction implements CommandLineRunner {

	@Autowired
	ApplicationContext appContext;

	public static void main(String[] args) {
		SpringApplication.run(DebugCheckConfigWebhooksLambdaFunction.class, args);
	}
