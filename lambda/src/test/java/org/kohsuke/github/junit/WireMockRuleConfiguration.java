 ...
 */
// https://github.com/hub4j/github-api/blob/main/src/test/java/org/kohsuke/github/junit/WireMockRuleConfiguration.java
public class WireMockRuleConfiguration implements Options {
	...
	public FileSource filesRoot() {
		if (childDirectory != null) {
			return parent.filesRoot().child(childDirectory);
		} else {
			return parent.filesRoot();
		}
	}
