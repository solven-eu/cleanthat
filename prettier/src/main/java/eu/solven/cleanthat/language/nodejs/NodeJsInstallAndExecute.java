...
public class NodeJsInstallAndExecute {
	...
	// See
	// https://github.com/eirslett/frontend-maven-plugin/blob/master/frontend-maven-plugin/
	// src/main/java/com/github/eirslett/maven/plugins/frontend/mojo/InstallNodeAndNpmMojo.java
