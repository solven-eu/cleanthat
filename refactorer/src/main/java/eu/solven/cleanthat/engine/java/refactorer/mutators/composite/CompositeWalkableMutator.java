 ...
 *
 */
public class CompositeWalkableMutator<AST> extends CompositeMutator<IWalkableMutator<AST>>
		implements IWalkableMutator<AST> {

	protected CompositeWalkableMutator(List<IWalkableMutator<AST>> mutators) {
