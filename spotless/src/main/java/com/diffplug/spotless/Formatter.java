...
public final class Formatter implements Serializable, AutoCloseable {
	...
	private Formatter(LineEnding.Policy lineEndingsPolicy,
			Charset encoding,
			Path rootDirectory,
			List<FormatterStep> steps,
			FormatExceptionPolicy exceptionPolicy) {
	...
	public static class Builder {
		...
		public Formatter build() {
			return new Formatter(lineEndingsPolicy,
					encoding,
					rootDir,
					steps,
	...
	/**
	 * Returns the result of calling all of the FormatterSteps. The input must have unix line endings, and the output is
	 * guaranteed to also have unix line endings.
	 */
	...
	public boolean equals(Object obj) {
		...
		return encoding.equals(other.encoding) && lineEndingsPolicy.equals(other.lineEndingsPolicy)
