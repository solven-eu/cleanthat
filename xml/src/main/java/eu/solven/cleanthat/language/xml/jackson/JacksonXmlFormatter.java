...
public class JacksonXmlFormatter implements ILintFixerWithId {
	private static final Logger LOGGER = LoggerFactory.getLogger(JacksonXmlFormatter.class);

	final ISourceCodeProperties sourceCodeProperties;

	final JacksonXmlFormatterProperties properties;

	final ObjectMapper formatter;

	public JacksonXmlFormatter(ISourceCodeProperties sourceCodeProperties, JacksonXmlFormatterProperties properties) {
